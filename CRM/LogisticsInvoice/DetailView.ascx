<%@ Control Language="c#" AutoEventWireup="false" CodeBehind="DetailView.ascx.cs" Inherits="Taoqi.TQLogisticsInvoice.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="divDetailView" runat="server">
    ...
    <Taoqi:ModuleHeader ID="ctlModuleHeader" Module="TQLogisticsInvoice" EnablePrint="false" HelpName="DetailView" EnableHelp="false" runat="Server" />
