                        ...
                        using (IDbConnection con = dbf.CreateConnection())
                        {
                            ...
                            if (!Sql.IsEmptyGuid(gID))
                            {
                                ...
                                sSQL = "select *             " + ControlChars.CrLf
                                     + "  from vwTQLogisticsInvoice_Edit" + ControlChars.CrLf
                            ...
                            using (IDbTransaction trn = Sql.BeginTransaction(con))
                            {
                                try
                                {
                                   ...
                                   SqlProcs.spTQLogisticsInvoice_Update
                                        (ref gID
                                        , new DynamicControl(this, rowCurrent, "C_SendName").Text
                                        , new DynamicControl(this, rowCurrent, "C_ReceiveName").Text
                                       , new DynamicControl(this, rowCurrent, "C_ProductName").Text
                                       , new DynamicControl(this, rowCurrent, "C_Quantity").DecimalValue
                                        , new DynamicControl(this, rowCurrent, "C_Unit").IntegerValue
                                        , new DynamicControl(this, rowCurrent, "C_Price").DecimalValue
                                        , new DynamicControl(this, rowCurrent, "C_Amount").DecimalValue
                                        , new DynamicControl(this, rowCurrent, "C_Drawer").Text
                                        , new DynamicControl(this, rowCurrent, "C_Payee").Text
                                        , new DynamicControl(this, rowCurrent, "C_InvoiceDate").DateValue
                                        , new DynamicControl(this, rowCurrent, "C_Remark").Text
                                    //    //, new DynamicControl(this, rowCurrent, "C_CountyID").ID
                                    //    //, new DynamicControl(this, rowCurrent, "C_Address").Text

                                    //    //, new DynamicControl(this, rowCurrent, "C_ContactName").Text
                                       
                                    //    //, new DynamicControl(this, rowCurrent, "C_Tel").Text
