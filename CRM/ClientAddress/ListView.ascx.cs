...
namespace Taoqi.TQClientAddress
{
    /// <summary>
    ...
    public class ListView : SplendidControl
    {
            ...
            try
            {
                ...
                else if (e.CommandName == "Export")
                {
                    ...
                    if (nACLACCESS >= 0)
                    {
                        ...
                        //string[] arrID = null;  // 11/27/2010   Checkbox selection is not sbtnDeleteupported for this module.
        ...
        protected void grdMain_OnSelectMethod(int nCurrentPageIndex, int nPageSize)
        {
            ...
            using (IDbConnection con = dbf.CreateConnection())
            {
                ...
                {
                    string sTABLE_NAME = "TQClientAddress";
            ...
            try
            {
                ...
                using (IDbConnection con = dbf.CreateConnection())
                {
                    ...
                    using (IDbCommand cmd = con.CreateCommand())
                    {
                        ...
                        cmd.CommandText = "  from vwTQClientAddress_List" + ControlChars.CrLf
                                        + " where 1 = 1           " + ControlChars.CrLf;
                ...
                if (!IsPostBack)
                {
                    ...
                    */
                    //DataTable dtHonourList = _code.CommonForCore.GetProcedureDataSet("spTQClientAddresss_RedTop10_Report", "@sector", c_company);
                    ...
                    //DataTable dtBlackList = _code.CommonForCore.GetProcedureDataSet("spTQClientAddresss_BlackTop10_Report", "@sector", c_company);
        ...
        void grdMain_ItemCommand(object source, DataGridCommandEventArgs e)
        {
            if (e.CommandName == "Delete")
            {
                ...
                SqlProcs.spTQClientAddress_Delete(id);
