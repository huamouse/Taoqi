<%@ Control Language="c#" AutoEventWireup="false" CodeBehind="EditView.ascx.cs" Inherits="Taoqi.TQOrderLogistics.EditView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div class="tableStyle">
    ...
    <div class="container_body">
        <div id="divEditView" runat="server">
            ...
            <Taoqi:ModuleHeader ID="ctlModuleHeader" Module="TQOrderLogistics" ModuleDisplayName="客户" Title="新建/编辑客户" EnablePrint="false" HelpName="EditView" EnableHelp="false" runat="Server" />
            <p>
