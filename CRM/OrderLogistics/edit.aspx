<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="Taoqi.TQOrderLogistics.Edit" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<Taoqi:EditView ID="ctlEditView" Visible='<%# Taoqi.Security.GetUserAccess("TQOrderLogistics", "edit") >= 0 %>' Runat="Server" />
