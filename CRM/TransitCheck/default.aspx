<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="default.aspx.cs" AutoEventWireup="false" Inherits="Taoqi.InTransitCheck.Default" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntSidebar" ContentPlaceHolderID="cntSidebar" runat="server">
	...
	<Taoqi:Shortcuts ID="ctlShortcuts" SubMenu="TQTransitCheck" Runat="Server" />
</asp:Content>

<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<%@ Register TagPrefix="Taoqi" Tagname="ListView" Src="ListView.ascx" %>
	<Taoqi:ListView ID="ctlListView" Visible='<%# Taoqi.Security.AdminUserAccess("TQTransitCheck", "list") >= 0 %>' Runat="Server" />
