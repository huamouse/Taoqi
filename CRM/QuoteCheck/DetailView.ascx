<%@ Control Language="c#" AutoEventWireup="false" CodeBehind="DetailView.ascx.cs" Inherits="Taoqi.TQuoteCheck.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div class="tableStyle1" >
    <div class="titleBar2">
        <div class="txt2" style="color: black;">«Ûπ∫±®º€…Û∫À</div>
...
<div id="divDetailView" runat="server">
    ...
    <Taoqi:ModuleHeader ID="ctlModuleHeader" Module="TQQuoteCheck" EnablePrint="false" HelpName="DetailView" EnableHelp="false" runat="Server" />
