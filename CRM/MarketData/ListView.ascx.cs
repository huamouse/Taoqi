    ...
    public class ListView : SplendidControl
    {
        ...
        protected void grdMain_OnSelectMethod(int nCurrentPageIndex, int nPageSize)
        {
            ...
            using (IDbConnection con = dbf.CreateConnection())
            {
                ...
                {
                    string sTABLE_NAME = "TQMarketData";
            ...
            try
            {
                ...
                using (IDbConnection con = dbf.CreateConnection())
                {
                    ...
                    using (IDbCommand cmd = con.CreateCommand())
                    {
                        ...
                        cmd.CommandText = "  from vwTQMarketData_List" + ControlChars.CrLf
                                        + " where 1 = 1           " + ControlChars.CrLf;
                        // 05/10/2007   ACL_ACCESS.OWNER is not defined for the EMPLOYEES module. 
                        //Security.Filter(cmd, m_sMODULE, "list");
                ...
                if (!IsPostBack)
                {
                    ...
                    */
                    //DataTable dtHonourList = _code.CommonForCore.GetProcedureDataSet("spTQMarketDatas_RedTop10_Report", "@sector", c_company);
                    ...
                    //DataTable dtBlackList = _code.CommonForCore.GetProcedureDataSet("spTQMarketDatas_BlackTop10_Report", "@sector", c_company);
