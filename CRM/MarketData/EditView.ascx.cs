                        ...
                        using (IDbConnection con = dbf.CreateConnection())
                        {
                            ...
                            if (!Sql.IsEmptyGuid(gID))
                            {
                                ...
                                sSQL = "select *             " + ControlChars.CrLf
                                     + "  from vwTQMarketData_Edit" + ControlChars.CrLf
                            ...
                            using (IDbTransaction trn = Sql.BeginTransaction(con))
                            {
                                try
                                {
                                    ...
                                    //    (ref gID
                                    //    , new DynamicControl(this, rowCurrent, "C_ProductID").ID

                                    //   , new DynamicControl(this, rowCurrent, "C_GuidePrice").IntegerValue
