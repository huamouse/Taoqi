	...
	public class TeamAssignedMassUpdate : SplendidControl
	{
		...
		public Guid PRIMARY_TEAM_ID
		{
			get
			{
				...
				{
					// 08/30/2009   Use a separate call to get the primary so that we don't 
		...
		{
			// 09/11/2007   If neither the assigned nor the team are visbile, then hide the entire user control. 
