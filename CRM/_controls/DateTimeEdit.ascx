<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DateTimeEdit.ascx.cs" Inherits="Taoqi._controls.DateTimeEdit" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<asp:Table BorderWidth="0" CellPadding="0" CellSpacing="0" runat="server">
	<asp:TableRow>
		...
		<asp:TableCell>
			...
			<Taoqi:TimeValidator  ID="valTIME" ControlToValidate="txtTIME" CssClass="required" EnableClientScript="false" EnableViewState="false" Enabled="false" Runat="server" />
