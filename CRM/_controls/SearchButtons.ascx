<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchButtons.ascx.cs" Inherits="Taoqi._controls.SearchButtons" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script runat="server">
/**********************************************************************************************************************
 ...
 * "Copyright (C) 2005-2011 Taoqi Software, Inc. All rights reserved."
 *********************************************************************************************************************/
// 07/28/2010   Must set the CellSpacing to 1 in order to get the padding to work.  Otherwise, border-collapse will be sent by the table. 
</script>
