<%@ Control Language="c#" AutoEventWireup="false" Codebehind="TeamAssignedMassUpdate.ascx.cs" Inherits="Taoqi._controls.TeamAssignedMassUpdate" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divTeamAssignedMassUpdate">
				<asp:Table Width="100%" CellPadding="0" CellSpacing="0" runat="server">
					<asp:TableRow>
						...
						<asp:TableCell Width="15%" CssClass="dataLabel"><asp:Label ID="lblTEAM" Visible="<%# Taoqi.Crm.Config.enable_team_management() %>" Text='<%# L10n.Term("Teams.LBL_TEAM") %>' runat="server" /></asp:TableCell>
						<asp:TableCell Width="35%" CssClass="dataField">
							<asp:Panel Visible="<%# Taoqi.Crm.Config.enable_team_management() && !Taoqi.Crm.Config.enable_dynamic_teams() %>" runat="server">
							...
							<%@ Register TagPrefix="Taoqi" Tagname="TeamSelect" Src="~/_controls/TeamSelect.ascx" %>
							<Taoqi:TeamSelect ID="ctlTeamSelect" Visible="<%# Taoqi.Crm.Config.enable_team_management() && Taoqi.Crm.Config.enable_dynamic_teams() %>" ShowAddReplace="true" Runat="Server" />
						</asp:TableCell>
					</asp:TableRow>
				</asp:Table>
</div>
