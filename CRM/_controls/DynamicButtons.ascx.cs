...
namespace Taoqi._controls
{
	...
	public class DynamicButtons : SplendidControl
	{
		...
		// 02/21/2010   Create Inline needs to be able to show all buttons. 
		public void ShowAll()
		{
			foreach ( Control ctl in pnlDynamicButtons.Controls )
			{
		...
		// 03/11/2014   Provide business rule access to the text. 
		...
		// 07/15/2010   We ned a quick way to find a button. 
		...
		// 10/29/2013   Provide a way to change the class name of the text. 
		...
		{
			// 04/29/2008   Don't create a reader if the ID is null. 
			// 04/28/2009   Always create the reader and read the first row.. 
			using ( DataTable dt = new DataTable() )
			{
				...
				{
					// 04/28/2009   Make sure to read the first row, otherwise an exception will be thrown when the reader is accessed. 
					//rdr.Read();
