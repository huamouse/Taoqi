<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailButtons.ascx.cs" Inherits="Taoqi._controls.DetailButtons" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script runat="server">
/**********************************************************************************************************************
