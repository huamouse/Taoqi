<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CRON.ascx.cs" Inherits="Taoqi._controls.CRON" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
