...
namespace Taoqi._controls
{
	...
	public class LastViewed : SplendidControl
	{
		...
		public void Refresh()
		{
			// 05/04/2010   LastViewed may not exist in the theme. 
			if ( ctlRepeater == null )
				return;
		...
		{
			// 12/02/2005   Always bind as the repeater does not save its state on postback. 
			Refresh();
		}
