...
namespace Taoqi._controls
{
	...
	{
        protected Taoqi.Themes.Sugar.Shortcuts ctlShortcuts;
		...
		public bool AdminShortcuts
		{
			get
			{
				// 01/20/2007   IsAdminPage is now a property of the SplendidPage. 
		...
		private void InitializeComponent()
		{
			...
			{
				ctlShortcuts = LoadControl(sShortcutsPath) as Taoqi.Themes.Sugar.Shortcuts;
				if ( ctlShortcuts != null )
				{
