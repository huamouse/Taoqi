<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailNavigation.ascx.cs" Inherits="Taoqi._controls.DetailNavigation" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script runat="server">
/**********************************************************************************************************************
 ...
 * "Copyright (C) 2005-2011 Taoqi Software, Inc. All rights reserved."
 *********************************************************************************************************************/
// 07/28/2010   The View Change Log link has been moved to a dynamic button. 
</script>
<div id="divModuleHeader">
	<script type="text/javascript">
	function PopupAudit()
	{
		window.open('<%= Application["rootURL"] %>Audit/Popup.aspx?ID=<%= gID %>&Module=<%= sModule %>', 'Audit', '<%= Taoqi.Crm.Config.PopupWindowOptions() %>,status=0,toolbar=0,location=0');
		return false;
	}
	</script>
