<%@ Control Language="c#" AutoEventWireup="false" Codebehind="LastViewed.ascx.cs" Inherits="Taoqi._controls.LastViewed" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script runat="server">
/**********************************************************************************************************************
		...
		<ItemTemplate>
			<nobr>
				<asp:HyperLink NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "RELATIVE_PATH") + "view.aspx?ID=" + DataBinder.Eval(Container.DataItem, "ITEM_ID") %>' 
					...
					<Taoqi:DynamicImage ImageSkinID='<%# DataBinder.Eval(Container.DataItem, "IMAGE_NAME") %>' AlternateText='<%# DataBinder.Eval(Container.DataItem, "ITEM_SUMMARY") %>' runat="server" />
					</asp:HyperLink>&nbsp;
				<asp:HyperLink NavigateUrl='<%# DataBinder.Eval(Container.DataItem, "RELATIVE_PATH") + "view.aspx?ID=" + DataBinder.Eval(Container.DataItem, "ITEM_ID") %>' 
					Text='<%# DataBinder.Eval(Container.DataItem, "ITEM_SUMMARY") %>' 
