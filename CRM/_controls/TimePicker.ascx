<%@ Control Language="c#" AutoEventWireup="false" Codebehind="TimePicker.ascx.cs" Inherits="Taoqi._controls.TimePicker" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script runat="server">
/**********************************************************************************************************************
