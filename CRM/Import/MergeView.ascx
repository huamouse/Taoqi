<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="MergeView.ascx.cs" Inherits="Taoqi.Import.MergeView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divMergeView">
	...
	<Taoqi:ModuleHeader ID="ctlModuleHeader" EnableModuleLabel="false" EnablePrint="true" HelpName="MergeView" EnableHelp="true" Runat="Server" />
	...
	<asp:Table SkinID="tabForm" runat="server">
		<asp:TableRow>
			<asp:TableCell>
				<p><asp:Label Text='<%# L10n.Term("Merge.LBL_DIFF_COL_VALUES") %>' Font-Bold="true" runat="server" /></p>
	...
	<asp:Table SkinID="tabForm" runat="server">
		<asp:TableRow>
			<asp:TableCell>
				<p><asp:Label Text='<%# L10n.Term("Merge.LBL_SAME_COL_VALUES") %>' Font-Bold="true" runat="server" /></p>
