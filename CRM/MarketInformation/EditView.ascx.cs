...
namespace Taoqi.TQMarketInformation
{
    /// <summary>
    ...
    public class EditView : SplendidControl
    {
        ...
        protected PlaceHolder PH_UploadImg;

        protected string C_CoverURL;
                        ...
                        using (IDbConnection con = dbf.CreateConnection())
                        {
                            ...
                            if (!Sql.IsEmptyGuid(gID))
                            {
                                ...
                                sSQL = "select *             " + ControlChars.CrLf
                                     + "  from vwTQMarketInformation_Edit" + ControlChars.CrLf
                            ...
                            using (IDbTransaction trn = Sql.BeginTransaction(con))
                            {
                                try
                                {
                                    ...
                                    SqlProcs.spTQMarketInformation_Update
                                        (ref gID
                                        , new DynamicControl(this, rowCurrent, "C_Type").IntegerValue

                                       , new DynamicControl(this, rowCurrent, "C_Title").Text

                                        , new DynamicControl(this, rowCurrent, "C_Content").Text
                                         , new DynamicControl(this, rowCurrent, "C_Introduction").Text
                                        , new DynamicControl(this, rowCurrent, "C_Author").Text

                                        , new DynamicControl(this, rowCurrent, "C_PublishDate").DateValue
                                        , new DynamicControl(this, rowCurrent, "C_ShowStatus").IntegerValue
                                         , new DynamicControl(this, rowCurrent, "C_Cover").Text
                                        , trn
                                        );
                                    trn.Commit();
        ...
        {
            PH_UploadImg = FindControl("UploadImg") as PlaceHolder;

            SetPageTitle("新建/编辑行业资讯");
                                ...
                                using (DbDataAdapter da = dbf.CreateDataAdapter())
                                {
                                    ...
                                    using (DataTable dtCurrent = new DataTable())
                                    {
                                        ...
                                        if (dtCurrent.Rows.Count > 0)
                                        {
                                            ...
                                            C_CoverURL = string.Format("/member/Data/Upload/Images/{0}", rdr["C_Cover"]);
