...
namespace WFServer
{
        ...
        public class SMTP
        {
            ...
            public SMTP(string[] mailTo, string mailSubjectFromSetting, string mailBodyFromSetting)
            {
                MailObject = new MailMessage();
                mMailFrom = Utils.AppSettings["EmailFromAddress"];
                mMailDisplyName = Utils.AppSettings["EmailDisplayName"];
                mMailTo = mailTo;
                mMailCc = null;
                mMailBcc = null;
                mMailSubject = Utils.AppSettings[mailSubjectFromSetting];
                mMailBody = Utils.AppSettings[mailBodyFromSetting];
                mMailAttachments = null;
                mSMTPServer = Utils.AppSettings["EmailDisplayName"];
                mSMTPPort = 25;
                mSMTPUsername = Utils.AppSettings["EmailUserName"];
                mSMTPPassword = Utils.AppSettings["EmailUserPassword"];
                mSMTPSSL = true;
            }
