    ...
    public class ListView : SplendidControl
    {
        ...
        protected void grdMain_OnSelectMethod(int nCurrentPageIndex, int nPageSize)
        {
            ...
            using (IDbConnection con = dbf.CreateConnection())
            {
                ...
                {
                    string sTABLE_NAME = "TQMyFavorite";
            ...
            try
            {
                ...
                using (IDbConnection con = dbf.CreateConnection())
                {
                    ...
                    using (IDbCommand cmd = con.CreateCommand())
                    {
                        ...
                        cmd.CommandText = "  from vwTQMyFavorite_List" + ControlChars.CrLf
                                        + " where 1 = 1           " + ControlChars.CrLf;
                ...
                if (!IsPostBack)
                {
                    ...
                    */
                    //DataTable dtHonourList = _code.CommonForCore.GetProcedureDataSet("spTQAttentions_RedTop10_Report", "@sector", c_company);
                    ...
                    //DataTable dtBlackList = _code.CommonForCore.GetProcedureDataSet("spTQAttentions_BlackTop10_Report", "@sector", c_company);
