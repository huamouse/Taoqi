...
namespace Taoqi.JavaScript
{
	...
	public class ModulePopupScripts : System.Web.UI.Page
	{
		...
		{
			// 11/20/2009   The module popup scripts do not change frequently and when the do, they get a new parameter. 
			Response.Cache.SetCacheability(HttpCacheability.Public);
			Response.Cache.SetExpires(DateTime.Now.AddMinutes(5));
			// 03/31/2012   Chrome is returning a warning: Resource interpreted as Script but transferred with MIME type text/html. 
