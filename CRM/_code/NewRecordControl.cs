...
namespace Taoqi
{
	public class NewRecordControl : InlineEditControl
	{
		...
		// 06/04/2010   Generate a load event so that the fields can be populated. 
		...
		public Guid PARENT_ID
		{
			get
			{
				// 02/21/2010   An EditView Inline will use the ViewState, and a NewRecord Inline will use the Request. 
		...
		// 04/19/2010   Allow the EditView to be redefined. 
