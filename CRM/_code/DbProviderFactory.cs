...
namespace Taoqi
{
	...
	public class DbProviderFactory
	{
		...
		public DbProviderFactory(string sConnectionString, string sAssemblyName, string sConnectionName, string sCommandName, string sDataAdapterName, string sParameterName, string sBuilderName)
		{
			...
			// 03/06/2006   Provide better error message if assembly cannot be loaded. 
			...
			// 04/21/2006   SQL Anywhere requires a boxed data adapter that inherits DbDataAdapter.
			if ( sDataAdapterName.StartsWith("Taoqi.") )
			...
			// 08/03/2006   Mono does not like the CommandBuilder. 
		...
		public IDbConnection CreateConnection()
		{
			...
			// 04/21/2006   Throw exception if NULL.  
			if ( con == null )
		...
		public DbDataAdapter CreateDataAdapter()
		{
			...
			// 04/21/2006   Throw exception if NULL.  SQL Anywhere is having a problem. 
			if ( da == null )
