...
namespace Taoqi
{
	public class RulesParser
	{
		...
		static RulesParser()
		{
			...
			// 11/29/2010   The Parser may not be available in .NET 4.0, so specify the 3.0 version. 
		...
		public RuleExpressionCondition ParseCondition(string expressionString)
		{
			...
			{
				// 10/22/2010    Instead of displaying "Exception has been thrown by the target of an invocation.", 
