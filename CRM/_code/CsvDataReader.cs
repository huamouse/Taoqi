						...
						switch ( nMode )
						{
							case 0:  // Search for next entry. 
							{
								if ( chFieldSeparator == ControlChars.Tab )
								{
									...
									// 01/28/2009   Make sure not to read past the end of the line. 
							...
							case 1:  // Determine if field is quoted or unquoted. 
							{
								...
								// 07/21/2010   Bug fix, this should be an else-if so that a bunch of empty fields don't confuse the parser. 
							...
							case 3:  // Extract quoted field. 
							{
								...
								do
								{
									...
									// 08/23/2006   If we are at the end of the line, then it must be a multi-line string. 
