...
namespace Taoqi.Users
{
	...
	public class Signatures : SplendidControl
	{
		...
		{
			// 08/07/2013   Team Management should not be required for signatures. 
			...
			if ( !IsPostBack )
			{
				...
				// 08/07/2013   My Account should have access to their signatures. 
				if ( !bMyAccount && !(Taoqi.Security.AdminUserAccess(m_sMODULE, "edit") >= 0) )
				{
