<%@ Page Language="C#"  MasterPageFile="~/DefaultView.master" AutoEventWireup="true" CodeBehind="SecurityInformInfo.aspx.cs" Inherits="Taoqi.Users.SecurityInfromInfo.SecurityInformInfo" %>
    ...
    <div id="SecurityInfo_View">
        ...
        <div style="border: solid #ddd; float: left; padding: 20px 15px; width: 100%; font-size: small;">
            ...
            <div style="width: 100%; border-bottom: solid #ddd; margin-top: 10px; margin-bottom: 40px; height: 40px;">
                ...
                <a href="./SecurityInfromInfo/SecurityInfromInfo.aspx">
                    <div class="navBoderColor navDiv">安全提示</div>
                </a>
