		...
		protected void Page_Command(Object sender, CommandEventArgs e)
		{
			try
			{
				if ( e.CommandName == "Login" )
				{
					...
					// 02/16/2011   Fix the error condition.  It was previously generating an error if the values were identical. 
					...
					if ( bPageIsValid )
					{
						...
						// 03/05/2011   After changing the password, use the new credentials to login. 
