<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="view.aspx.cs" AutoEventWireup="false" Inherits="Taoqi.Users.UserSignatures.View" %>
<script runat="server">
/**********************************************************************************************************************
...
<asp:Content ID="cntSidebar" ContentPlaceHolderID="cntSidebar" runat="server">
	...
	<Taoqi:Shortcuts ID="ctlShortcuts" SubMenu="UserSignatures" Runat="Server" />
</asp:Content>

<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	<%@ Register TagPrefix="Taoqi" Tagname="DetailView" Src="DetailView.ascx" %>
	<Taoqi:DetailView ID="ctlDetailView" Visible='<%# Taoqi.Security.GetUserAccess("UserSignatures", "view") >= 0 %>' Runat="Server" />
