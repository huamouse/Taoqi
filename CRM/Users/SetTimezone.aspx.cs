		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if ( !IsPostBack )
			{
				...
				try
				{
					...
					// 09/01/2008   We might have a case issue, so instead of using SelectedValue, manually search. 
					string sDEFAULT_TIMEZONE = SplendidDefaults.TimeZone();
					lstTIMEZONE.DataBind();
					// 08/19/2010   We have a function that will do a case-insignificant selection. 
