...
[assembly: System.Web.UI.WebResource("Taoqi.Users.SplendidPasswordExtenderBehavior.js", "text/javascript")]
#endregion

namespace Taoqi
{
	[TargetControlType(typeof(TextBox))]
	[AjaxControlToolkit.ClientScriptResource("Sys.Extended.UI.SplendidPasswordExtenderBehavior", "Taoqi.Users.SplendidPasswordExtenderBehavior.js")]
	...
	public class SplendidPassword : AjaxControlToolkit.ExtenderControlBase
	{
		...
		public bool IsValid(string pwd, ref string pwdRequirements)
		{
			...
			if ( this.MinimumLowerCaseCharacters > 0 && this.MinimumUpperCaseCharacters > 0 )
			{
				...
				int numUpper = lowercaseRegex.Matches(pwd).Count;
				...
				else
				{
					if ( pwdRequirements != String.Empty )
						pwdRequirements += ", ";
					pwdRequirements += this.MessageRemainingMixedCase;
				}
			}
			...
			if ( this.MinimumSymbolCharacters > 0 )
			{
				...
				if ( this.SymbolCharacters != null && this.SymbolCharacters != String.Empty )
				{
					...
					// 03/05/2011   Fix issue with escaping the symbol characters. 
