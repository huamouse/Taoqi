<%@ Control Language="c#" AutoEventWireup="false" Codebehind="NewRecord.ascx.cs" Inherits="Taoqi.Administration.EditCustomFields.NewRecord" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divNewRecord" Visible="false" runat="server">
	...
	<Taoqi:ListHeader ID="ctlListHeader" Title="EditCustomFields.LBL_ADD_FIELD" Runat="Server" />
