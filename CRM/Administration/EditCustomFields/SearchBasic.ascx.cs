...
namespace Taoqi.Administration.EditCustomFields
{
	...
	public class SearchBasic : SearchControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if ( !this.IsPostBack )
			{
				// 05/20/2007   Make sure to copy the table before modifying the data, otherwise the changes will get applied to the cached table. 
				...
				// 01/05/2006   Can't seem to set the selected value from ListView.ascx. 
