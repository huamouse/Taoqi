<%@ Control CodeBehind="EmailsView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.EmailsView" %>
<script runat="server">
/**********************************************************************************************************************
...
(  Taoqi.Security.AdminUserAccess("EmailMan"    , "access") >= 0 
|| Taoqi.Security.AdminUserAccess("InboundEmail", "access") >= 0 
) %>' runat="server">
	<p>
	<%@ Register TagPrefix="Taoqi" Tagname="ListHeader" Src="~/_controls/ListHeader.ascx" %>
	<Taoqi:ListHeader Title="Administration.LBL_EMAIL_TITLE" Runat="Server" />
	<asp:Table Width="100%" CssClass="tabDetailView2" runat="server">
		<asp:TableRow>
			<asp:TableCell Width="20%" CssClass="tabDetailViewDL2" Visible='<%# Taoqi.Security.AdminUserAccess("EmailMan", "edit") >= 0 %>'>
			...
			<asp:TableCell Width="30%" CssClass="tabDetailViewDF2" Visible='<%# Taoqi.Security.AdminUserAccess("EmailMan", "edit") >= 0 %>'>
				<asp:Label Text='<%# L10n.Term("Administration.LBL_MASS_EMAIL_CONFIG_DESC") %>' runat="server" />
			</asp:TableCell>
			<asp:TableCell Width="20%" CssClass="tabDetailViewDL2" Visible='<%# Taoqi.Security.AdminUserAccess("EmailMan", "list") >= 0 %>'>
			...
			<asp:TableCell Width="30%" CssClass="tabDetailViewDF2" Visible='<%# Taoqi.Security.AdminUserAccess("EmailMan", "list") >= 0 %>'>
				<asp:Label Text='<%# L10n.Term("Administration.LBL_MASS_EMAIL_MANAGER_DESC") %>' runat="server" />
			</asp:TableCell>
		</asp:TableRow>
		<asp:TableRow>
			<asp:TableCell Width="20%" CssClass="tabDetailViewDL2" Visible='<%# Taoqi.Security.AdminUserAccess("InboundEmail", "access") >= 0 %>'>
			...
			<asp:TableCell Width="30%" CssClass="tabDetailViewDF2" Visible='<%# Taoqi.Security.AdminUserAccess("InboundEmail", "access") >= 0 %>'>
		...
		<asp:TableRow>
			<asp:TableCell Width="20%" CssClass="tabDetailViewDL2" Visible='<%# Taoqi.Security.AdminUserAccess("OutboundEmail", "access") >= 0 %>'>
			...
			<asp:TableCell Width="30%" CssClass="tabDetailViewDF2" Visible='<%# Taoqi.Security.AdminUserAccess("OutboundEmail", "access") >= 0 %>'>
