<%@ Control CodeBehind="AccessView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.ACLRoles.AccessView" %>
<script runat="server">
/**********************************************************************************************************************
...
function toggleDisplay(sID)
{
	...
	if ( fldLink != null )
	{
		// 02/28/2008   The linked field is the opposite of the main. 
...
<div id="divListView">
	...
	<Taoqi:ACLGrid id="grdACL" Width="100%" CssClass="tabDetailView"
	...
	<asp:Panel ID="pnlAdmin" runat="server">
		<br />
		<Taoqi:ACLGrid id="grdACL_Admin" Width="100%" CssClass="tabDetailView"
			CellPadding="0" CellSpacing="1" border="0"
			AllowPaging="false" AllowSorting="false" 
			AutoGenerateColumns="false" EnableACLEditing="false"
			EnableViewState="true" runat="server">
