<%@ Control CodeBehind="UserRolesView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.ACLRoles.UserRolesView" %>
<script runat="server">
/**********************************************************************************************************************
...
{
	return window.open('PopupMultiSelect.aspx', 'RolePopup', '<%= Taoqi.Crm.Config.PopupWindowOptions() %>');
}
</script>
<%@ Register TagPrefix="Taoqi" Tagname="ListHeader" Src="~/_controls/ListHeader.ascx" %>
<Taoqi:ListHeader Visible="<%# !PrintView %>" Title="ACLRoles.LBL_SEARCH_FORM_TITLE" Runat="Server" />
