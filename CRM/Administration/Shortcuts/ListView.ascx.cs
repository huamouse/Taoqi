...
namespace Taoqi.Administration.Shortcuts
{
	/// <summary>
	...
	public class ListView : SplendidControl
	{
		...
		protected void Page_Command(object sender, CommandEventArgs e)
		{
			try
			{
				...
				else if ( e.CommandName == "Shortcuts.Delete" )
				{
					...
					// 05/22/2008   Use AJAX and rebind after move operation. 
					BindGrid(true);
				}
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if ( !IsPostBack )
				{
					// 12/13/2007   Manually enable AutoPostBack. 
					if ( MODULE_NAME != null )
					{
				...
				// 10/02/2013   Always get the current module name. 
				if ( MODULE_NAME != null )
		...
		private void InitializeComponent()
		{
			...
			// 11/24/2005   Add fields early so that sort events will get called. 
			m_sMODULE = "Shortcuts";
			SetMenu(m_sMODULE);
			// 04/27/2008   We need to build a list of the fields used by the search clause. 
