<%@ Control Language="c#" AutoEventWireup="false" Codebehind="EditView.ascx.cs" Inherits="Taoqi.Administration.Releases.EditView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divEditView" runat="server">
	...
	<Taoqi:ModuleHeader ID="ctlModuleHeader" Module="Releases" EnablePrint="false" HelpName="EditView" EnableHelp="true" Runat="Server" />
	<p>
