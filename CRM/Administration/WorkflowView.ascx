<%@ Control CodeBehind="WorkflowView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.WorkflowView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divWorkflowView" visible='<%# ( Taoqi.Security.AdminUserAccess("BusinessRules", "access") >= 0 ) %>' runat="server">
	<p>
	<%@ Register TagPrefix="Taoqi" Tagname="ListHeader" Src="~/_controls/ListHeader.ascx" %>
	<Taoqi:ListHeader Title="BusinessRules.LBL_BUSINESS_RULES_TITLE" Runat="Server" />
	<asp:Label ID="lblError" CssClass="error" EnableViewState="false" Runat="server" />

	<asp:Table Width="100%" CssClass="tabDetailView2" runat="server">
		<asp:TableRow>
			<asp:TableCell Width="20%" CssClass="tabDetailViewDL2" Visible='<%# Taoqi.Security.AdminUserAccess("BusinessRules", "access") >= 0 %>'>
