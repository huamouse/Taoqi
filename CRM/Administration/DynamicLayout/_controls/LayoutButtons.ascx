<%@ Control Language="c#" AutoEventWireup="false" Codebehind="LayoutButtons.ascx.cs" Inherits="Taoqi.Administration.DynamicLayout._controls.LayoutButtons" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
 ...
 * "Copyright (C) 2005-2011 Taoqi Software, Inc. All rights reserved."
 *********************************************************************************************************************/
// 07/14/2010   We need to use InlineScript because this user control is inside an UpdatePanel 
