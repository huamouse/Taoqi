...
namespace Taoqi.Administration.DynamicLayout._controls
{
	/// <summary>
	///		Summary description for LayoutButtons.
	/// </summary>
	public class LayoutButtons : Taoqi._controls.EditButtons
	{
		...
		{
			// 04/11/2011   We cannot use the chkPreview.checked field because we are calling Preview too early. 
			// We need to get the flag directly from the Request. 
			// 04/11/2011   We need to save the previous value so that the the binding can happen properly in the InitializeComponent. 
			if ( bInitialize )
		...
		// 02/14/2013   Provide access to the CopyLayout textbox. 
