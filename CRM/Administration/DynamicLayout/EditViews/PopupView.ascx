<%@ Control CodeBehind="PopupView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.DynamicLayout.EditViews.PopupView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divPopupView">
	...
	<Taoqi:SearchView ID="ctlSearchView" Module="DynamicLayout" SearchMode="EditView.PopupView" IsPopupSearch="true" ShowSearchTabs="false" Visible="<%# !PrintView %>" Runat="Server" />

	<%@ Register TagPrefix="Taoqi" Tagname="ListHeader" Src="~/_controls/ListHeader.ascx" %>
	<Taoqi:ListHeader Title="DynamicLayout.LBL_EDIT_VIEW_LAYOUT" Runat="Server" />
