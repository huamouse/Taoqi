...
namespace Taoqi.Administration.DynamicLayout.EditViews
{
	...
	{
		protected Taoqi._controls.SearchView     ctlSearchView    ;
		protected Taoqi._controls.DynamicButtons ctlDynamicButtons;
		...
		{    
			...
			arrSelectFields.Add("EDIT_NAME");
			this.AppendGridColumns(grdMain, m_sMODULE + ".EditView.PopupView", arrSelectFields);
