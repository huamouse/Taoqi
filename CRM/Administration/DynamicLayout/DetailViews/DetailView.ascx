<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="Taoqi.Administration.DynamicLayout.DetailViews.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divDetailView" runat="server">
	...
	<Taoqi:ModuleHeader ID="ctlModuleHeader" Module="Administration" Title="DynamicLayout.LBL_DETAIL_VIEW_LAYOUT" EnablePrint="true" HelpName="DetailView" EnableHelp="true" Runat="Server" />
	...
	<asp:Table Width="100%" runat="server">
		<asp:TableRow>
			...
			<asp:TableCell VerticalAlign="Top">
				...
				<br />
				<%@ Register TagPrefix="Taoqi" Tagname="NewRecord" Src="~/Administration/DynamicLayout/DetailViews/NewRecord.ascx" %>
