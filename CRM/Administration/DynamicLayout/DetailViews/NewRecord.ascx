<%@ Control Language="c#" AutoEventWireup="false" Codebehind="NewRecord.ascx.cs" Inherits="Taoqi.Administration.DynamicLayout.DetailViews.NewRecord" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divNewRecord">
	...
	<Taoqi:ListHeader ID="ctlListHeader" Title="DynamicLayout.LBL_DETAIL_VIEW_FIELD" Runat="Server" />
