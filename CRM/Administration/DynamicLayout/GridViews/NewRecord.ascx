<%@ Control Language="c#" AutoEventWireup="false" Codebehind="NewRecord.ascx.cs" Inherits="Taoqi.Administration.DynamicLayout.GridViews.NewRecord" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<Taoqi:InlineScript runat="server">
	...
	{
		return window.open('Popup.aspx', 'LayoutFieldSelect', '<%= Taoqi.Crm.Config.PopupWindowOptions() %>');
	}
	</script>
</Taoqi:InlineScript>
<div id="divNewRecord">
	...
	<Taoqi:ListHeader ID="ctlListHeader" Title="DynamicLayout.LBL_GRID_VIEW_FIELD" Runat="Server" />
		...
		<asp:TableRow>
			<asp:TableCell>
				<asp:Table SkinID="tabEditView" runat="server">
					<asp:TableRow>
						<asp:TableCell Width="25%" CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_FIELD_TYPE") %>' runat="server" /></asp:TableCell>
					...
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_DATA_FORMAT") %>' runat="server" />&nbsp;(<asp:CheckBox ID="chkFREE_FORM_FORMAT" OnCheckedChanged="chkFREE_FORM_FORMAT_CheckedChanged" CssClass="checkbox" AutoPostBack="True" Runat="server" /> <asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_FREE_FORM_DATA" ) %>' runat="server" />)</asp:TableCell>
						<asp:TableCell CssClass="dataField">
					...
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_SORT_EXPRESSION"   ) %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField"><asp:DropDownList ID="lstSORT_EXPRESSION" DataTextField="ColumnName" DataValueField="ColumnName" Runat="server" /></asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_ITEMSTYLE_WIDTH"   ) %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField"><asp:TextBox ID="txtITEMSTYLE_WIDTH"    size="35" Runat="server" /></asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_ITEMSTYLE_CSSCLASS") %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField"><asp:TextBox ID="txtITEMSTYLE_CSSCLASS" size="35" Runat="server" /></asp:TableCell>
					</asp:TableRow>
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_ITEMSTYLE_HORIZONTAL_ALIGN") %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField">
					...
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_ITEMSTYLE_VERTICAL_ALIGN") %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField">
					...
					<asp:TableRow>
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_ITEMSTYLE_WRAP"    ) %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField"><asp:CheckBox ID="chkITEMSTYLE_WRAP" class="checkbox" Runat="server" /></asp:TableCell>
					</asp:TableRow>
					...
					<asp:TableRow ID="trURL_TARGET" runat="server">
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_URL_TARGET"        ) %>' runat="server" /></asp:TableCell>
					...
					<asp:TableRow ID="trURL_MODULE" runat="server">
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_URL_MODULE"        ) %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField"><asp:TextBox ID="txtURL_MODULE"         size="35" Runat="server" /></asp:TableCell>
					</asp:TableRow>
					<asp:TableRow ID="trURL_ASSIGNED_FIELD" runat="server">
						<asp:TableCell CssClass="dataLabel"><asp:Label Text='<%# L10n.Term("DynamicLayout.LBL_URL_ASSIGNED_FIELD") %>' runat="server" /></asp:TableCell>
						<asp:TableCell CssClass="dataField"><asp:TextBox ID="txtURL_ASSIGNED_FIELD" size="35" Runat="server" /></asp:TableCell>
					</asp:TableRow>
