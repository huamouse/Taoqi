...
namespace Taoqi.Administration.DynamicLayout.GridViews
{
	...
	public class NewRecord : DynamicLayout.NewRecord
	{
		...
		{
			// 06/19/2010   JavaScript data format show show URL Field, Format and Target. 
			// 08/02/2010   The Hover control is very similar to a JavaScript control. 
			// 02/28/2014   JavaImage is just like JavaScript, but shows an icon. 
			// 03/01/2014   ImageButton is just like JavaScript, but shows an icon and has a command event. 
			...
			trURL_FORMAT        .Visible = (lstFIELD_TYPE.SelectedValue == "HyperLinkColumn" || lstDATA_FORMAT.SelectedValue == "HyperLink" || lstDATA_FORMAT.SelectedValue == "JavaScript" || lstDATA_FORMAT.SelectedValue == "Hover" || lstDATA_FORMAT.SelectedValue == "JavaImage" || lstDATA_FORMAT.SelectedValue == "ImageButton");
			...
			// 02/17/2010   The Module Type only applies to TemplateColumn HyperLink. 
