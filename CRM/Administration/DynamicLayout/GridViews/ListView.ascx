<%@ Control CodeBehind="ListView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.DynamicLayout.GridViews.ListView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divListView">
	...
	<Taoqi:ModuleHeader ID="ctlModuleHeader" Module="Administration" Title="DynamicLayout.LBL_GRID_VIEW_LAYOUT" EnablePrint="true" HelpName="index" EnableHelp="true" Runat="Server" />
	...
	<asp:Table Width="100%" runat="server">
		<asp:TableRow>
			<asp:TableCell Width="200px" VerticalAlign="Top">
				...
				<Taoqi:SearchBasic ID="ctlSearch" ViewTableName="vwGRIDVIEWS_Layout" ViewFieldName="GRID_NAME" Runat="Server" />
			</asp:TableCell>
			<asp:TableCell VerticalAlign="Top">
				...
				<br />
				<%@ Register TagPrefix="Taoqi" Tagname="NewRecord" Src="~/Administration/DynamicLayout/GridViews/NewRecord.ascx" %>
