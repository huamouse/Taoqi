<%@ Control Language="c#" AutoEventWireup="false" Codebehind="NewRecord.ascx.cs" Inherits="Taoqi.Administration.Terminology.NewRecord" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divNewRecord">
	...
	<Taoqi:HeaderLeft ID="ctlHeaderLeft" Title="Terminology.LBL_NEW_FORM_TITLE" Runat="Server" />
...
<%
// 01/12/2006   NewRecord is having a problem setting the value in the code-behind. 
if ( !IsPostBack )
