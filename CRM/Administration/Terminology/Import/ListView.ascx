<%@ Control CodeBehind="ListView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.Terminology.Import.ListView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divListView">
	...
	<Taoqi:ModuleHeader ID="ctlModuleHeader" Module="Terminology" Title=".LBL_IMPORT" EnablePrint="false" HelpName="index" EnableHelp="true" Runat="Server" />
	<%@ Register TagPrefix="Taoqi" Tagname="ListHeader" Src="~/_controls/ListHeader.ascx" %>
	<Taoqi:ListHeader Title="Administration.LBL_IMPORT_TERMINOLOGY_TITLE" Runat="Server" />
	...
	<%@ Register TagPrefix="Taoqi" Tagname="SplendidLanguagePacks" Src="SplendidLanguagePacks.ascx" %>
	<Taoqi:SplendidLanguagePacks ID="ctlSplendidLanguagePacks" Runat="Server" />
	<%@ Register TagPrefix="Taoqi" Tagname="LanguagePacks" Src="LanguagePacks.ascx" %>
	<Taoqi:LanguagePacks ID="ctlLanguagePacks" Runat="Server" />
</div>
