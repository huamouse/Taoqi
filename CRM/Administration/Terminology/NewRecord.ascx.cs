	...
	public class NewRecord : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if ( !bIsPostBack )
			{
				...
				if ( NotPostBack )
					this.DataBind();
				// 01/12/2006   Language cannot be null. 
				...
				// 01/12/2006   Insert is failing, but I don't know why.  
				...
				try
				{
					// 01/12/2006   Set default value to current language. 
					// 01/12/2006   This is not working.  Use client-side script to select the default. 
