<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="Taoqi.Administration.Terminology.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<Taoqi:ListHeader Title="Terminology.LBL_SEARCH_FORM_TITLE" Runat="Server" />
<div id="divSearch">
