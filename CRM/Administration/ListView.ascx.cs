...
namespace Taoqi.Administration
{
	...
	public class ListView : SplendidControl
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			// 03/15/2010   An Admin Delegate can see this page. 
			this.Visible = Taoqi.Security.isAdmin || Taoqi.Security.IS_ADMIN_DELEGATE;
			if ( !this.Visible )
				return;
		...
		private void InitializeComponent()
		{
			...
			SetMenu(m_sMODULE);
			// 12/04/2009   We do not want to use the tabbed view in this area. 
			this.AppendDetailViewRelationships(m_sMODULE + "." + LayoutListView, plcSubPanel, Guid.Empty, false, false);
		}
		#endregion
	}
}
