...
namespace Taoqi.Calendar
{
	...
	public class MonthView : CalendarControl
	{
		...
		{
			// 03/19/2007   Odd problem whereby clicking on the current day does nothing. All other days work. 
		...
		{
			// 01/16/2007   Catch any exceptions and log them. We are having a problem with duplicate ASSIGNED_USER_ID parameters. 
			try
			{
				...
				if ( !e.Day.IsOtherMonth )
				{
					...
					foreach(DataRowView row in vwMain)
					{
						...
						Image img = new Image();
						// 04/09/2008   Could not get SkinID to work here.  Must be too late in the cycle. 
