...
namespace Taoqi.Calendar
{
	...
	public class Popup : SplendidPopup
	{
		...
		{
			this.ClientScript.RegisterClientScriptBlock(System.Type.GetType("System.String"), "closewindow", "<script type=\"text/javascript\">SelectDate('" + Sql.ToDateString(ctlCalendar.SelectedDate) + "');</script>");
		}
