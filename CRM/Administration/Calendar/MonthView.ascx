<%@ Control CodeBehind="MonthView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Calendar.MonthView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divDetailView" runat="server">
	...
	<Taoqi:ModuleHeader ID="ctlModuleHeader" Module="Calendar" Title="Calendar.LBL_MODULE_TITLE" EnableModuleLabel="false" EnablePrint="true" HelpName="MonthView" EnableHelp="true" Runat="Server" />
	...
	<asp:Table SkinID="tabFrame" runat="server">
		<asp:TableRow>
			<asp:TableCell VerticalAlign="Top">
				...
				<Taoqi:CalendarHeader ID="ctlCalendarHeader" ActiveTab="Month" Runat="Server" />
