<%@ Control CodeBehind="WeekGrid.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Calendar.WeekGrid" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divWeek">
	...
	<Taoqi:CalendarHeader ID="ctlCalendarHeader" ActiveTab="Week" Runat="Server" />
				...
				<asp:Table SkinID="tabFrame" CssClass="monthHeader" runat="server">
					<asp:TableRow>
						<asp:TableCell Width="1%" CssClass="monthHeaderPrevTd" Wrap="false">
							<asp:ImageButton CommandName="Week.Previous" OnCommand="Page_Command" CssClass="NextPrevLink" AlternateText='<%# L10n.Term("Calendar.LBL_PREVIOUS_WEEK") %>' SkinID="calendar_previous" Runat="server" />&nbsp;
						...
						<asp:TableCell Width="1%" HorizontalAlign="Right" CssClass="monthHeaderNextTd" Wrap="false">
							...
							<asp:ImageButton CommandName="Week.Next" OnCommand="Page_Command" CssClass="NextPrevLink" AlternateText='<%# L10n.Term("Calendar.LBL_NEXT_WEEK") %>' SkinID="calendar_next" Runat="server" />
						</asp:TableCell>
					</asp:TableRow>
				</asp:Table>
			</asp:TableCell>
