<%@ Control Language="c#" AutoEventWireup="false" Codebehind="NewRecord.ascx.cs" Inherits="Taoqi.Calendar.NewRecord" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divNewRecord">
	...
	<Taoqi:HeaderLeft ID="ctlHeaderLeft" Title="Calendar.LNK_NEW_APPOINTMENT" Runat="Server" />
	...
	<asp:Panel Width="100%" CssClass="leftColumnModuleS3" runat="server">
		...
		<Taoqi:DatePicker ID="ctlDATE_START" Runat="Server" />
