<%@ Control CodeBehind="DayGrid.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Calendar.DayGrid" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divDay">
	...
	<Taoqi:CalendarHeader ID="ctlCalendarHeader" ActiveTab="Day" Runat="Server" />
