<%@ Control CodeBehind="SharedGrid.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Calendar.SharedGrid" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="SharedGrid">
	...
	<Taoqi:CalendarHeader ID="ctlCalendarHeader" ActiveTab="Shared" Runat="Server" />
