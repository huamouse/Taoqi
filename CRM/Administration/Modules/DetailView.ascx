<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DetailView.ascx.cs" Inherits="Taoqi.Administration.Modules.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divDetailView" runat="server">
	...
	<Taoqi:ModuleHeader ID="ctlModuleHeader" Module="Modules" EnablePrint="true" HelpName="DetailView" EnableHelp="true" Runat="Server" />
