...
namespace Taoqi.Administration.AuditEvents
{
	/// <summary>
	...
	public class ListView : SplendidControl
	{
		...
		// 11/19/2012   Add support for custom paging. 
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				// 11/19/2012   The Audit Table can be very large, so always use custom paging. 
