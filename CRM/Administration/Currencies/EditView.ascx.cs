	...
	public class EditView : SplendidControl
	{
						...
						using ( IDbConnection con = dbf.CreateConnection() )
						{
							...
							using ( IDbTransaction trn = Sql.BeginTransaction(con) )
							{
								try
								{
									...
									// 05/10/2006   Sql.ToFloat() was having a problem when an alternate decimal point is used. 
									...
									// 07/07/2007   The currency in the application scope needs to be updated. 
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				//Page.DataBind();  // 09/03/2005  DataBind is required in order for the RequiredFieldValidators to work. 
