...
namespace Taoqi.Administration.Languages
{
	/// <summary>
					...
					if ( Page.IsValid )
					{
						...
						using ( IDbConnection con = dbf.CreateConnection() )
						{
							...
							using ( IDbTransaction trn = Sql.BeginTransaction(con) )
							{
								try
								{
									SqlProcs.spLANGUAGES_Update
										( ref gID
										, new DynamicControl(this, "NAME"                    ).Text
										, new DynamicControl(this, "LCID"                    ).IntegerValue
										, new DynamicControl(this, "ACTIVE"                  ).Checked
										, new DynamicControl(this, "NATIVE_NAME"             ).Text
										, new DynamicControl(this, "DISPLAY_NAME"            ).Text
										, trn
										);
									trn.Commit();
								}
								...
								using ( DbDataAdapter da = dbf.CreateDataAdapter() )
								{
									...
									using ( DataTable dtCurrent = new DataTable() )
									{
										...
										if ( dtCurrent.Rows.Count > 0 )
										{
											...
											// 12/16/2013   Language should not be tracked.  There is no icon and a direct link does not work. 
											...
											if ( txtNAME != null )
												txtNAME.Focus();
											// 11/27/2013   DATE_MODIFIED is not available in the view. 
