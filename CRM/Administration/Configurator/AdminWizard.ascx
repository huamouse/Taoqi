<%@ Control CodeBehind="AdminWizard.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.Configurator.AdminWizard" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divAdminWizard">
	<script runat="server">
	// 07/09/2010   There is a documented issue with a FileUpload control inside an UpdatePanel. 
