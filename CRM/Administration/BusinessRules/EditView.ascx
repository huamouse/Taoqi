<%@ Control CodeBehind="EditView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.BusinessRules.EditView" %>
<script runat="server">
/**********************************************************************************************************************
...
<div id="divEditView" runat="server">
	...
	<Taoqi:ModuleHeader ID="ctlModuleHeader" Module="BusinessRules" Title=".moduleList.Home" EnablePrint="false" HelpName="Wizard" EnableHelp="true" Visible="<%# ShowHeader %>" Runat="Server" />

	<asp:UpdatePanel UpdateMode="Conditional" runat="server">
		<ContentTemplate>
			<p>
			<%@ Register TagPrefix="Taoqi" Tagname="DynamicButtons" Src="~/_controls/DynamicButtons.ascx" %>
			<Taoqi:DynamicButtons ID="ctlDynamicButtons" Visible="<%# ShowTopButtons && !PrintView %>" ShowRequired="true" Runat="Server" />
			...
			<Taoqi:DynamicButtons ID="ctlFooterButtons" Visible="<%# ShowBottomButtons && !PrintView %>" ShowRequired="false" Runat="Server" />
			<!-- 06/26/2011   InlineScript with DumpSQL is causing a JavaScript error in Chrome, Firefox and Safari. -->
		</ContentTemplate>
	</asp:UpdatePanel>
</div>
