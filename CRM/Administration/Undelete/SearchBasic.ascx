<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SearchBasic.ascx.cs" Inherits="Taoqi.Administration.Undelete.SearchBasic" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
<%@ Register TagPrefix="Taoqi" Tagname="DatePicker" Src="~/_controls/DatePicker.ascx" %>
<script runat="server">
/**********************************************************************************************************************
						...
						<asp:TableCell CssClass="dataField" VerticalAlign="Top" Wrap="false" RowSpan="2">
							<asp:Table runat="server">
								<asp:TableRow>
									...
									<asp:TableCell><Taoqi:DatePicker ID="ctlSTART_DATE" Runat="Server" /></asp:TableCell>
								</asp:TableRow>
								<asp:TableRow>
									<asp:TableCell><%= L10n.Term("SavedSearch.LBL_SEARCH_BEFORE") %></asp:TableCell>
									<asp:TableCell><Taoqi:DatePicker ID="ctlEND_DATE"   Runat="Server" /></asp:TableCell>
								</asp:TableRow>
							</asp:Table>
						</asp:TableCell>
					</asp:TableRow>
