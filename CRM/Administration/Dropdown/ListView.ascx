<%@ Control CodeBehind="ListView.ascx.cs" Language="c#" AutoEventWireup="false" Inherits="Taoqi.Administration.Dropdown.ListView" %>
...
<div id="divListView">
	...
	<Taoqi:ModuleHeader ID="ctlModuleHeader" Module="Dropdown" Title=".moduleList.Home" EnablePrint="true" HelpName="index" EnableHelp="true" Runat="Server" />
	...
	<Taoqi:ListHeader ID="ctlListHeader" Title="Dropdown.LBL_LIST_FORM_TITLE" Visible="false" Runat="Server" />
	...
	<asp:UpdatePanel runat="server">
		<ContentTemplate>
			...
			<Taoqi:SplendidGrid id="grdMain" AllowPaging="false" AllowSorting="false" EnableViewState="true" ShowFooter='<%# Taoqi.Security.AdminUserAccess(m_sMODULE, "edit") >= 0 %>' runat="server">
				<Columns>
					...
					<asp:TemplateColumn HeaderText="" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Left" ItemStyle-Wrap="false" Visible="false">
						<ItemTemplate>
							<asp:ImageButton Visible='<%# Container.ItemIndex != grdMain.EditItemIndex && Taoqi.Security.AdminUserAccess(m_sMODULE, "edit"  ) >= 0 %>' CommandName="Dropdown.MoveUp"   CommandArgument='<%# Eval("ID") %>' OnCommand="Page_Command" CssClass="listViewTdToolsS1" AlternateText='<%# L10n.Term("Dropdown.LNK_UP") %>' SkinID="uparrow_inline" Runat="server" />
							<asp:LinkButton  Visible='<%# Container.ItemIndex != grdMain.EditItemIndex && Taoqi.Security.AdminUserAccess(m_sMODULE, "edit"  ) >= 0 %>' CommandName="Dropdown.MoveUp"   CommandArgument='<%# Eval("ID") %>' OnCommand="Page_Command" CssClass="listViewTdToolsS1" Text='<%# L10n.Term("Dropdown.LNK_UP") %>' Runat="server" />
							&nbsp;
							<asp:ImageButton Visible='<%# Container.ItemIndex != grdMain.EditItemIndex && Taoqi.Security.AdminUserAccess(m_sMODULE, "edit"  ) >= 0 %>' CommandName="Dropdown.MoveDown" CommandArgument='<%# Eval("ID") %>' OnCommand="Page_Command" CssClass="listViewTdToolsS1" AlternateText='<%# L10n.Term("Dropdown.LNK_DOWN") %>' SkinID="downarrow_inline" Runat="server" />
							<asp:LinkButton  Visible='<%# Container.ItemIndex != grdMain.EditItemIndex && Taoqi.Security.AdminUserAccess(m_sMODULE, "edit"  ) >= 0 %>' CommandName="Dropdown.MoveDown" CommandArgument='<%# Eval("ID") %>' OnCommand="Page_Command" CssClass="listViewTdToolsS1" Text='<%# L10n.Term("Dropdown.LNK_DOWN") %>' Runat="server" />
						</ItemTemplate>
					</asp:TemplateColumn>
					...
					<asp:TemplateColumn HeaderText="" ItemStyle-Width="20%" ItemStyle-HorizontalAlign="Right" ItemStyle-Wrap="false">
						<ItemTemplate>
							...
							&nbsp;
							<asp:ImageButton Visible='<%# Container.ItemIndex != grdMain.EditItemIndex && Taoqi.Security.AdminUserAccess(m_sMODULE, "edit"  ) >= 0 %>' CommandName="Edit"     CommandArgument='<%# Eval("ID") %>' CssClass="listViewTdToolsS1" AlternateText='<%# L10n.Term(".LNK_EDIT") %>' SkinID="edit_inline" Runat="server" />
							<asp:LinkButton  Visible='<%# Container.ItemIndex != grdMain.EditItemIndex && Taoqi.Security.AdminUserAccess(m_sMODULE, "edit"  ) >= 0 %>' CommandName="Edit"     CommandArgument='<%# Eval("ID") %>' CssClass="listViewTdToolsS1" Text='<%# L10n.Term(".LNK_EDIT") %>' Runat="server" />
							&nbsp;
							<asp:ImageButton Visible='<%# Container.ItemIndex != grdMain.EditItemIndex && Taoqi.Security.AdminUserAccess(m_sMODULE, "delete") >= 0 %>' CommandName="Delete"   CommandArgument='<%# Eval("ID") %>' CssClass="listViewTdToolsS1" AlternateText='<%# L10n.Term(".LNK_DELETE") %>' SkinID="delete_inline" Runat="server" />
							<asp:LinkButton  Visible='<%# Container.ItemIndex != grdMain.EditItemIndex && Taoqi.Security.AdminUserAccess(m_sMODULE, "delete") >= 0 %>' CommandName="Delete"   CommandArgument='<%# Eval("ID") %>' CssClass="listViewTdToolsS1" Text='<%# L10n.Term(".LNK_DELETE") %>' Runat="server" />
						</ItemTemplate>
						<FooterTemplate>
							<asp:Button ID="btnInsert" CommandName="Insert" Text='<%# L10n.Term(".LBL_ADD_BUTTON_LABEL") %>' Visible='<%# Taoqi.Security.AdminUserAccess(m_sMODULE, "edit") >= 0 %>' runat="server" />
						</FooterTemplate>
					</asp:TemplateColumn>
				</Columns>
			</Taoqi:SplendidGrid>
