                        ...
                        using (IDbConnection con = dbf.CreateConnection())
                        {
                            ...
                            using (IDbTransaction trn = Sql.BeginTransaction(con))
                            {
                                try
                                {
                                   ...
                                   SqlProcs.spTQRewardPoint_Update
                                        (ref gID
                                        , new DynamicControl(this, rowCurrent, "C_PointNumber").IntegerValue
                                        , new DynamicControl(this, rowCurrent, "C_PointResource").Text
                                        , new DynamicControl(this, rowCurrent, "C_PointChange").Text
                                      
                                       , new DynamicControl(this, rowCurrent, "C_Remark").Text
                                    //    //, new DynamicControl(this, rowCurrent, "C_RegionID").ID
