<%@ Page language="c#" MasterPageFile="~/DefaultView.Master" Codebehind="edit.aspx.cs" AutoEventWireup="false" Inherits="Taoqi.TQRewardPoint.Edit" %>
...
<asp:Content ID="cntBody" ContentPlaceHolderID="cntBody" runat="server">
	...
	<Taoqi:EditView ID="ctlEditView" Visible='<%# Taoqi.Security.GetUserAccess("TQRewardPoint", "edit") >= 0 %>' Runat="Server" />
