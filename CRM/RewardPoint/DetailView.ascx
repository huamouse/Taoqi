<%@ Control Language="c#" AutoEventWireup="false" CodeBehind="DetailView.ascx.cs" Inherits="Taoqi.TQRewardPoint.DetailView" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<div id="divDetailView" runat="server">
    ...
    <Taoqi:ModuleHeader ID="ctlModuleHeader" Module="TQRewardPoint" EnablePrint="false" HelpName="DetailView" EnableHelp="false" runat="Server" />
